...
#| fig-cap: "Responses collected over time."
...
Respondents entered `r length(comments$comments)` comments. The two tables below show 20 random quotes stratified by whether their satisfaction ratings were positive or negative using the above binning method.  
